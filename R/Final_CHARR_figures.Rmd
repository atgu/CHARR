...
p<- v3_dp20 %>%
  ...
  themes
p
png(paste0(figure_path, 'S10_gnomad_v3_charr_bimodality_pcr_free_hist_all.png'), height = 4, width = 6, units = 'in', res = 300)
print(p)
dev.off()
```


# Supplement Figure 11 | Freemix score old vs. recomputed version
```{r}
save <- T
...
figS11_hgdp_freemix_before_after(hgdp, 'S11', save = save, height = 4, width = 6)
```

# Supplement Figure 12 | CHARR vs. Freemix Score before and after on HGDP samples
```{r}
save <- T
figS12_hgdp_charr_freemix_before_after(hgdp %>% filter(s %in% v3_meta$s), 'S12', save=save, height = 5, width = 7.5)
```

# Supplement Figure 13 | HGDP sample selection
```{r}
save = T
fig13_hgdp_sample_selection('S13', save=save, height = 4, width = 10)
```

# Supplement Figure 14 | CHARR vs. Freemix Score before and after decontamination on the selected HGDP samples
```{r}
save= T
figS14_sample_decontamination('S14', save=save, height = 4, width = 7.5)
```

# Supplement Figure 15 | 2 way freemixscore vs. CHARR color by the truth
```{r}
save = T
figure1 = figS15_2_way_color_by_truth('S15A', save=save, height = 4, width = 6, type = 'gnomAD')
figure2 = figS15_2_way_color_by_truth('S15B', save=save, height = 4, width = 6, type = 'sample')
...
png(paste0(figure_path, 'S15_hgdp_2_way_mixed_150_samples.png'), height = 4, width = 8, units = 'in', res = 300)
print(figure)
dev.off()
```

# Supplement Figure 16 | het/hom ratios of the two-way mixing results
```{r}
save = T
figS16_two_way_mixing_het_hom_ratio('S16', save=save, height = 4, width = 6)
```

# Supplement Figure 17 | N-way mixing results CHARR. vs. Freemix Score
```{r}
save = T
figS17_n_way_mixing('S17', save=save, height = 6, width = 8)
```

# Supplement Figure 18 | N-way mixing boxplot
```{r}
save = T
figS18_n_way_box_plot('S18_gnomad_', save=save, height = 3.5, width = 7)
```

# Supplement Figure 19 | two-way vs. N-way mixing results
```{r}
save = T
figS19_2_way_vs_n_way('S19', save=save, height = 4.5, width = 9, type = 'gnomAD')
figS19_2_way_vs_n_way('S19', save=save, height = 4.5, width = 9, type = 'sample')
```